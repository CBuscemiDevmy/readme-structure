...
- [CSS Skeleton Loading](https://www.youtube.com/watch?v=ZVug65gW-fc)
...
- [Animista](https://animista.net/play/entrances/rotate-in)
- [loading.io](https://loading.io/) - Loading Spinner Generator
...
- [CSSBattle - the CSS code-golfing game!](https://cssbattle.dev/)

...
- [React – A JavaScript library for building user interfaces](https://reactjs.org/) - Official WebSite
...
- [How to use global variables in CSS-Modules](https://stackoverflow.com/questions/40779623/how-to-use-global-variables-in-css-modules)
- [React Course Styling with CSS Modules](https://www.youtube.com/watch?v=ZZtbJFhpO3s)
...
- [React Hooks calling child component method from parent](https://dev.to/007_dark_shadow/react-hooks-calling-child-component-method-from-parent-144p)
...
## Storybook and React (custom design system)

- [React Storybook Crach Course](https://www.youtube.com/watch?v=FUKpWgRyPlU)
...
- [React Select](https://react-select.com/components)
- [Pusher](https://github.com/pusher/pusher-js#web)
